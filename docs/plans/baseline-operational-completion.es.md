...
El documento de referencia de OpenAPI exige `@nestjs/swagger`, pero no está presente en
`package.json` y no hay inicialización de Swagger verificada. No lo considere una API lista para
implementar.
