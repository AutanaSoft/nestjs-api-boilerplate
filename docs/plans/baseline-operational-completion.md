...
The OpenAPI owner requires `@nestjs/swagger`, but it is not present in `package.json` and no Swagger
bootstrap is verified. Do not treat it as an implementation-ready API.
